...
/This package is considered stable, though [[https://codeberg.org/seahorse/yabaki-theme/pulls][pull requests]] are welcome/
...
=git clone https://codeberg.org/seahorse/yabaki-theme.git=
